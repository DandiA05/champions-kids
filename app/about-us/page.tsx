                ...
                <div className="history-info-inner">
                    ...
                    <div className="history-info-number">
                      <div className="time">
                        <div className="text-center">
                          <span className="month text-black">October</span>
                          <span className="year text-black">2012</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="history-info-item">
                    ...
                    <div className="history-info-number order-md-2">
                      <div className="time">
                        <div className="text-center">
                          <span className="month text-black">April</span>
                          <span className="year text-black">2018</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="history-info-item pb-0">
                    ...
                    <div className="history-info-number">
                      <div className="time">
                        <div className="text-center">
                          <span className="month text-black">January</span>
